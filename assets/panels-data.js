...
const PANELS = {
  ...
  "bar-kitchen": {
    ...
    circuits: [
      ...
      { position: "L15-17", side: "L", phase: "RYB", label: "Dishwasher — triple-pole breaker (spans positions 15–17)" },
      ...
      { position: "R5-7", side: "R", phase: "RYB", label: "Coffee Grinder — triple-pole breaker (spans positions 5–7)" },
