...
const PANELS = {
  ...
  "bar-kitchen": {
    ...
    circuits: [
      ...
      { position: "L10", side: "L", phase: "R", label: "(no printed label)", flag: true, flagNote: "Handwritten 'MICROWAVE 2' near this breaker — verify." },
      { position: "L11", side: "L", phase: "Y", label: "Kitchen Lights", flag: true, flagNote: "Printed label partly crossed out / overwritten by hand." },
      { position: "L12", side: "L", phase: "B", label: "Cellar Lights" },
      { position: "L13", side: "L", phase: "R", label: "Spot Lights" },
      { position: "L14", side: "L", phase: "Y", label: "EMG Lights", flag: true, flagNote: "Handwritten annotation above label is illegible." },
      { position: "L15", side: "L", phase: "B", label: "Dishwasher" },
      ...
      { position: "R6",  side: "R", phase: "B", label: "Coffee Grinder" },
      { position: "R7",  side: "R", phase: "R", label: "Coffee Grinder" },
      { position: "R8",  side: "R", phase: "Y", label: "Glasswash" },
      { position: "R9",  side: "R", phase: "B", label: "Contactor for Signs" },
      { position: "R10", side: "R", phase: "R", label: "Insectocutors" },
      { position: "R11", side: "R", phase: "Y", label: "Kitchen Ring" },
      { position: "R12", side: "R", phase: "B", label: "Kitchen Ring" },
      { position: "R13", side: "R", phase: "R", label: "Bottle Room Ring" },
      { position: "R14", side: "R", phase: "Y", label: "Bar Ring" },
      { position: "R15", side: "R", phase: "B", label: "Bar Ring" },
      { position: "R16", side: "R", phase: "R", label: "EMG Lights" },
    ]
  },
